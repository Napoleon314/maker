...
IF(MSVC)
	...
	IF(BUILD_ARCH_NAME MATCHES "x86")
		...
		SET(CMAKE_SHARED_LINKER_FLAGS "/WX /SAFESEH:NO")
		SET(CMAKE_MODULE_LINKER_FLAGS "/WX /SAFESEH:NO")
	ELSE()
	...
	FUNCTION(CREATE_VCPROJ_USERFILE TARGETNAME DIR)
		SET(_WORKING_DIR ${DIR})
		SET(_CMD_LINE "")
		CONFIGURE_FILE(
			${DEPENDENT_PATH}/maker/VisualStudioUserFile.vcxproj.user.in
...
FUNCTION(CREATE_PROJECT_USERFILE PROJECTNAME TARGETNAME DIR)
	IF(MSVC)
		CREATE_VCPROJ_USERFILE(${TARGETNAME} ${DIR})
	ENDIF()
ENDFUNCTION()
